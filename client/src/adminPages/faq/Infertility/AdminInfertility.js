...
import { fetchEntries, createEntry, updateEntry, deleteEntry } from '../../faq/Infertility/InfertilitySlice';
import Swal from 'sweetalert2';

const AdminInfertility = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      <form onSubmit={handleSubmit} className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">{editingId ? 'Edit' : 'Add'} Infertility</h2>
        <input
          type="text"
          name="title"
...
export default AdminInfertility;
